...
<%@page import="java.sql.*"%>
 ...
 <% 
    ...
    Notice n = new JdbcNoticeDao().getNotice(code);
            ...
            <main id="main">
                ...
                <article id="notice-detail" class="space-top-l">
                    ...
                    <dl>
                        ...
                        <dd class="detail-cell text-highlight"><input type="text" value="${n.title}" name="title"></dd>
                    ...
                    <p id="button-container" class="space-top text-center">
                    	<input type="hidden" name="code" value="${n.code}"> <!-- 주소에 심어서 보냄 -->
